...
//    int value = _minuteRange.first + index;
  ...
  List<int> _calcHourRange() {
    ...
    if (_currDay == _dayRange!.first) {
      minHour = _minTime?.hour??0;
    }
    if (_currDay == _dayRange!.last) {
      maxHour = _maxTime?.hour??23;
    }
